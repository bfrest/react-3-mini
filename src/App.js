...
class App extends Component {
  ...
  getVehicles() {
    axios
      .get("https://joes-autos.herokuapp.com/api/vehicles?year=2000&color=green")
      .then(results => {
    ...
    return (
      <div className="">
        ...
        <div className="btn-container">
          ...
          <select onChange={this.filterByMake} ref="selectedMake" className="btn-sp" value="">
          ...
          <select ref="selectedColor" onChange={this.filterByColor} className="btn-sp" value="">
            <option value="" disabled>
              Filter by color
            </option>
          ...
          <input onChange={this.nameSearch} placeholder="Search by name" type="text" ref="searchLetters" />

          <input ref="searchYear" className="btn-sp" type="number" placeholder="Year" />
